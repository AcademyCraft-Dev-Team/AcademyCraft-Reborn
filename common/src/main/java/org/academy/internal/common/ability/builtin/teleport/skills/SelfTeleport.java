...
public final class SelfTeleport extends Skill {
    ...
    public void initClient() {
        KEY_START = AcademyCraftClient.CLIENT_CONFIG.getKey(Client.KEY_NAME_START,
                new InputSystem.InputPair(InputSystem.InputType.KEYBOARD, new InputSystem.KeyInfo(
                        new LinkedHashSet<>(Set.of(GLFW.GLFW_KEY_Z)),
                        GLFW.GLFW_PRESS,
                        new LinkedHashSet<>()
                )));
        KEY_END = AcademyCraftClient.CLIENT_CONFIG.getKey(Client.KEY_NAME_END,
                new InputSystem.InputPair(InputSystem.InputType.KEYBOARD, new InputSystem.KeyInfo(
                        new LinkedHashSet<>(Set.of(GLFW.GLFW_KEY_Z)),
                        GLFW.GLFW_RELEASE,
                        new LinkedHashSet<>()
    ...
    private static final class Client {
        ...
        private static void start() {
            if (ClientUtil.hasScreen()
                //        || ClientUtil.lacksSkill(INSTANCE)
            ) return;
            started = true;
        }
