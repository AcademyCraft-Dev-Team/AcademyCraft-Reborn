...
public class AcademyCraftEntityTypes {
    ...
    public static final EntityType<HighSpeedElectronBeam> HIGH_SPEED_ELECTRON_BEAM_ENTITY_TYPE = EntityType.Builder.of(HighSpeedElectronBeam::new, MobCategory.MISC).sized(0, 0).build("high_speed_electron_beam");
