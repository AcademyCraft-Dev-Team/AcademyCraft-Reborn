...
public class WindGenWorldGUI {
    ...
    public void onInit() {
        ...
        {
            ImageWidget back = new ImageWidget(0, 0, WIDTH, HEIGHT, ImageResources.RenderTypes.RENDER_TYPE_SKILL_PANEL_INFO);
            mainPanel.addChild("back", back);
            ImageButtonWidget buttonWidget = new ImageButtonWidget(320, 200, 50, 50, ImageResources.RenderTypes.RENDER_TYPE_ICON_NODE, new Runnable() {
                @Override
                public void run() {
