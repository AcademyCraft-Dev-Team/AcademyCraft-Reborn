...
public class WirelessNodeModel extends HierarchicalModel<Entity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition innner_ef = all.addOrReplaceChild("innner_ef", CubeListBuilder.create().texOffs(3, 2).addBox(-10.0F, -9.0F, 7.9F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-11.0F, -10.0F, 7.9F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 2).addBox(-15.0F, -12.0F, 7.9F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-3.0F, -12.0F, 7.9F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-5.0F, -9.0F, 7.9F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-8.0F, -11.0F, 7.9F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(1, 2).addBox(-9.0F, -12.0F, 7.9F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-8.0F, -6.0F, 7.9F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(1, 2).addBox(-9.0F, -5.0F, 7.9F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 60).addBox(-15.0F, -4.0F, 7.9F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 60).addBox(-15.0F, -16.0F, 7.9F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-4.0F, -10.0F, 7.9F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-10.0F, -9.0F, -7.9F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-11.0F, -10.0F, -7.9F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 2).addBox(-15.0F, -12.0F, -7.9F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-3.0F, -12.0F, -7.9F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-5.0F, -9.0F, -7.9F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(-2, 60).addBox(-15.0F, -16.0F, -7.9F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-4.0F, -10.0F, -7.9F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-1, -2).addBox(-4.0F, -15.9F, -5.0F, 1.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(-1, -2).addBox(-4.0F, -15.9F, 1.0F, 1.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, -1).addBox(-5.0F, -15.9F, -5.0F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, -1).addBox(-5.0F, -15.9F, 2.0F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, -1).addBox(-10.0F, -15.9F, -5.0F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, -1).addBox(-10.0F, -15.9F, 2.0F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(-1, -2).addBox(-11.0F, -15.9F, -5.0F, 1.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(-16, -14).addBox(-15.0F, -15.9F, -8.0F, 4.0F, 0.0F, 16.0F, new CubeDeformation(0.0F))
                .texOffs(-16, -14).addBox(-3.0F, -15.9F, -8.0F, 4.0F, 0.0F, 16.0F, new CubeDeformation(0.0F))
                .texOffs(-1, -2).addBox(-11.0F, -15.9F, 1.0F, 1.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(1, 0).addBox(-6.0F, -15.9F, -5.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(1, 0).addBox(-6.0F, -15.9F, 3.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(1, 0).addBox(-9.0F, -15.9F, -5.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(1, 0).addBox(-9.0F, -15.9F, 3.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(1, 1).addBox(-8.0F, -15.9F, 4.0F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(1, 1).addBox(-8.0F, -15.9F, -5.0F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(-4, -1).addBox(-11.0F, -15.9F, -8.0F, 8.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(-4, -1).addBox(-11.0F, -15.9F, 5.0F, 8.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(-16, 48).addBox(-15.0F, -0.1F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, 0.0F, 0.0F));

        innner_ef.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(3, 2).addBox(3.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 60).addBox(-8.0F, -8.0F, 0.0F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 60).addBox(-8.0F, 4.0F, 0.0F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(1, 2).addBox(-2.0F, 3.0F, 0.0F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-1.0F, 2.0F, 0.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(1, 2).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(2.0F, -1.0F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(4.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 2).addBox(-8.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-4.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-3.0F, -1.0F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9F, -8.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        innner_ef.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(3, 2).addBox(3.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 60).addBox(-8.0F, -8.0F, 0.0F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 60).addBox(-8.0F, 4.0F, 0.0F, 16.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(1, 2).addBox(-2.0F, 3.0F, 0.0F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(2, 2).addBox(-1.0F, 2.0F, 0.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 2).addBox(-8.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-4.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(3, 2).addBox(-3.0F, -1.0F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.9F, -8.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
