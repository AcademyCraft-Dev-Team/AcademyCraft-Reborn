...
public class NetworkResourceLocations {
    ...
    public static final ResourceLocation S2C_OPEN_ABILITY_DEVELOPER_SCREEN_PACKET = new ResourceLocation(AcademyCraft.MOD_ID, "s2c_open_ability_developer_fragment_packet");
