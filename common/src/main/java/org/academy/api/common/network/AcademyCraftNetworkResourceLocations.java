...
public class AcademyCraftNetworkResourceLocations {
    ...
    public static final ResourceLocation S2C_ARC_GENERATE_RESPONSE = new ResourceLocation(AcademyCraft.MOD_ID, "s2c_arc_generate_response");
    ...
    public static final ResourceLocation C2S_HIGH_SPEED_ELECTRON_BEAM_REQUEST = new ResourceLocation(AcademyCraft.MOD_ID, "c2s_high_speed_electron_beam_request");
    public static final ResourceLocation S2C_HIGH_SPEED_ELECTRON_BEAM_RESPONSE = new ResourceLocation(AcademyCraft.MOD_ID, "s2c_high_speed_electron_beam_response");
