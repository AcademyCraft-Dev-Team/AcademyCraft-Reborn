package org.academy.internal.client.renderer.blockentity.fabric;
...
import org.academy.fabric.AcademyCraftItemsImpl;
import org.academy.internal.common.world.level.block.fabric.AbilityDeveloperBlock;
import org.academy.internal.common.world.level.block.entity.fabric.AbilityDeveloperBlockEntity;
...
public class AbilityDeveloperBlockEntityRenderer implements BlockEntityRenderer<AbilityDeveloperBlockEntity> {
    ...
    public void render(@NotNull AbilityDeveloperBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource buffer, int packedLight, int packedOverlay) {
        if (blockEntity.isMain()) {
            poseStack.pushPose();
            ItemStack itemStack = new ItemStack(AcademyCraftItemsImpl.ABILITY_DEVELOPER_BLOCK_ITEM.asItem());
