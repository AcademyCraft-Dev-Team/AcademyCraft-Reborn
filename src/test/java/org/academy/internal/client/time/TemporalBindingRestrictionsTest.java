...
class TemporalBindingRestrictionsTest {
    @Test void immunityBeforeOrAfterDisableRestoresOnlyOriginallyEnabledBindings() {
    ...
    @Test void repeatedLockAndImmunityExpiryDoNotLoseTheOriginalState() {
        var state = new TemporalBindingRestrictions();
    ...
    @Test void ownerGuiOrHudWriteSupersedesLegacyExternalRequest() {
        var state = new TemporalBindingRestrictions();
