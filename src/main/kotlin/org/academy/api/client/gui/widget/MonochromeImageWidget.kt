...
import org.academy.api.client.gui.command.MonochromeImageDrawCommand

class MonochromeImageWidget(texture: Identifier) : ImageWidget(texture) {
    override fun generateDrawCommand(
        ...
        return MonochromeImageDrawCommand(
