...
public final class VfxGraphRenderer {
    ...
    public void render(GpuTextureView target, @Nullable GpuTextureView depth, ParticleBuffer buffer,
        ...
        boolean useSceneDepth = anyBillboard && sceneDepthUsable(IrisCompat.isShaderPackInUse(), RenderSpec.Geometry.QUAD);
    ...
    private void drawInstanced(
        ...
        var depthView = sceneDepthUsable(IrisCompat.isShaderPackInUse(), spec.geometry())
