...
public final class PostEffect {
    ...
    public static void pre() {
        ...
        PostEffect.runBlitPass(MAIN_SCENE, Render.RenderPipelines.BLIT_SCREEN, Map.of("DiffuseSampler", mainRenderTarget.getColorTextureView()), Collections.emptyMap(), false);
