...
public class AcademyCraftRequestHandlersClient {
    public static final Map<ResourceLocation, AcademyCraftRequestHandlerClient> RESPONSE_MAP = new HashMap<>();
    ...
    private AcademyCraftRequestHandlersClient() {
    }
}