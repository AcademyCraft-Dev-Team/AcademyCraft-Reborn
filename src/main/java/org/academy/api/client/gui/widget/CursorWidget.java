...
public class CursorWidget extends AbstractWidget {
    ...
    private void renderSDFGlowAndShadow(MatrixStack stack, MultiBufferSource.BufferSource bufferSource) {
        ...
        vertexConsumer.addVertex(matrix4f, x, y + h, z).setUv(0, 1);
        vertexConsumer.addVertex(matrix4f, x + w, y + h, z).setUv(1, 1);
        vertexConsumer.addVertex(matrix4f, x + w, y, z).setUv(1, 0);
        vertexConsumer.addVertex(matrix4f, x, y, z).setUv(0, 0);
        ...
        vertexConsumer.addVertex(glowMatrix, x, y + h, z).setUv(0, 1);
        vertexConsumer.addVertex(glowMatrix, x + w, y + h, z).setUv(1, 1);
        vertexConsumer.addVertex(glowMatrix, x + w, y, z).setUv(1, 0);
        vertexConsumer.addVertex(glowMatrix, x, y, z).setUv(0, 0);
        bufferSource.endBatch(renderType);
    }
}