...
public class FriendlyByteBufSerializers {
    ...
    public static final FriendlyByteBufSerializer<Byte> BYTE_FRIENDLY_BYTE_BUF_SERIALIZER = registerSerializer(Byte.class, IFriendlyByteBufExtension::writeByte);
    ...
    public static final FriendlyByteBufSerializer<BlockPos> BLOCK_POS_FRIENDLY_BYTE_BUF_SERIALIZER = registerSerializer(BlockPos.class, (buffer, value) -> buffer.writeBlockPos(value));
    public static final FriendlyByteBufSerializer<UUID> UUID_FRIENDLY_BYTE_BUF_SERIALIZER = registerSerializer(UUID.class, (buffer, value) -> buffer.writeUUID(value));
    public static final FriendlyByteBufSerializer<Vector3f> VECTOR_3_F_FRIENDLY_BYTE_BUF_SERIALIZER = registerSerializer(Vector3f.class, (buffer, value) -> buffer.writeVector3f(value));
    public static final FriendlyByteBufSerializer<Tag> COMPOUND_TAG_FRIENDLY_BYTE_BUF_SERIALIZER = registerSerializer(Tag.class, (buffer, value) -> buffer.writeNbt(value));
    ...
    public static final FriendlyByteBufSerializer<BlockPos.MutableBlockPos> MUTABLE_BLOCK_POS_FRIENDLY_BYTE_BUF_SERIALIZER = registerSerializer(BlockPos.MutableBlockPos.class, (buffer, value) -> buffer.writeBlockPos(value));
