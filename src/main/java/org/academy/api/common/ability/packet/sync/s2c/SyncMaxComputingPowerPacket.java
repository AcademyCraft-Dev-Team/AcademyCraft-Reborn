...
public final class SyncMaxComputingPowerPacket extends Packet<ClientGamePacketListener, SyncMaxComputingPowerPacket> {
    ...
    @Override
    public PacketType<ClientGamePacketListener, SyncMaxComputingPowerPacket> getPacketType() {
