...
public final class DarkmatterModifiers {
    ...
    public static synchronized void bootstrap() {
        ...
        bootstrapped = true;
        var allOffense = EnumSet.of(DarkmatterShape.TOOL, DarkmatterShape.SWORD,
                DarkmatterShape.SPEAR, DarkmatterShape.TRIDENT, DarkmatterShape.BOW,
                DarkmatterShape.CROSSBOW, DarkmatterShape.MACE, DarkmatterShape.ARROW);
        ...
        var equipment = EnumSet.of(DarkmatterShape.TOOL, DarkmatterShape.SWORD,
                DarkmatterShape.SPEAR, DarkmatterShape.TRIDENT, DarkmatterShape.BOW,
                DarkmatterShape.CROSSBOW, DarkmatterShape.MACE, DarkmatterShape.ARMOR);
        register(SHEAR, 1, 1, 1, EnumSet.of(DarkmatterShape.TOOL));
        register(HARVEST, 3, 1, 1, EnumSet.of(DarkmatterShape.TOOL));
        register(TILL, 1, 1, 1, EnumSet.of(DarkmatterShape.TOOL));
        register(TELEPORT_SUPPRESSION, 3, 1, 4, allOffense);
        register(TELEPORT_PROTECTION, 2, 2, 4,
                EnumSet.of(DarkmatterShape.ARMOR, DarkmatterShape.ARROW));
        register(PULL, 3, 1, 3, allOffense, Set.of(KNOCKBACK));
        register(KNOCKBACK, 3, 1, 3, allOffense, Set.of(PULL));
        register(EXPLOSIVE, 3, 2, 4, allOffense);
        register(MAGNETIC, 3, 1, 1, EnumSet.of(DarkmatterShape.TOOL,
                DarkmatterShape.SWORD, DarkmatterShape.SPEAR, DarkmatterShape.TRIDENT,
                DarkmatterShape.BOW, DarkmatterShape.CROSSBOW, DarkmatterShape.MACE));
        register(ANTIGRAVITY, 3, 1, 3, equipment);
        register(EDIBLE, 1, 1, 1, allOffense);
        register(HOLY, 3, 1, 2, allOffense);
        register(DISMEMBER, 3, 1, 2, allOffense);
        register(SLAUGHTER, 3, 1, 2, allOffense);
        register(DRYING, 3, 1, 2, allOffense);
        register(EXTINGUISH, 3, 1, 2, allOffense);
        register(FREEZING, 3, 1, 4, allOffense, Set.of(BURNING));
        ...
        register(FEATHER_PURSUIT, 3, 2, 5, allOffense);
        register(STRUCTURAL_GUARD, 3, 2, 5, EnumSet.of(DarkmatterShape.ARMOR));
    }
