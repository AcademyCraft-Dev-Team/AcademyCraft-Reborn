...
public final class QqProvider implements MusicProviderApi {
     ...
     */
    @Override
    public List<org.academy.internal.common.music.SharedTrackEntry> importPlaylist(
            String dissid,
        ...
        List<org.academy.internal.common.music.SharedTrackEntry> entries = new ArrayList<>();
        for (var element : data.getAsJsonArray("songlist")) {
            var song = element.getAsJsonObject();
            entries.add(new org.academy.internal.common.music.SharedTrackEntry(
                    NAME,
                    getString(song, "mid"),
                    getString(song, "name"),
                    joinSingers(song),
    ...
    private JsonObject requireReqData(JsonObject root, String moduleKey) throws IOException {
        if (root == null) {
