...
public final class DarkmatterMaceItem extends MaceItem implements DarkmatterShapedItem {
    public DarkmatterMaceItem(Properties properties) {
        super(DarkmatterNativeItemSupport.equipmentProperties(properties));
    }

    @Override public DarkmatterShape darkmatterShape() { return DarkmatterShape.MACE; }
