...
public final class MusicAccountPackets {
    ...
    public static final class Server {
        ...
        public static void onResolveRequest(ResolveRequestPacket packet) {
            org.academy.internal.server.music.ResolveService.handleRequest(packet, packet.getPacketListener().getPlayer());
        }

        @SubscribePacket
        public static void onAccountAction(AccountActionPacket packet) {
            org.academy.internal.server.music.SharedAccountService.handleAction(packet, packet.getPacketListener().getPlayer());
        }

        @SubscribePacket
        public static void onPlaylistRequest(PlaylistRequestPacket packet) {
            var store = org.academy.internal.server.music.PresetPlaylistStore.getInstance();
