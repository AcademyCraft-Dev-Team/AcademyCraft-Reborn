...
public class Level0PassiveLv2 extends Skill {
    ...
    public static final class Client {
        public static final AbilitySystemClient.SkillInfo SKILL_INFO = AbilitySystemClient.addCommonSkillInfo(
                new AbilitySystemClient.SkillInfo(Skills.LEVEL0_PASSIVE_LV2.get(), List.of(Level0PassiveLv1.Client.SKILL_INFO), R.textures.ability.level0.skill.level0_passive_lv2.icon, 75, 62)
        );
