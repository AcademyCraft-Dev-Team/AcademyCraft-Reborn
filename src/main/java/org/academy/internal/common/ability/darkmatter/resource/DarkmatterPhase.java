package org.academy.internal.common.ability.darkmatter.resource;
...
public final class DarkmatterPhase {
    ...
    public static float alpha(ServerPlayer player) {
        return snapshot(player).alphaPower();
    }

    public static float beta(ServerPlayer player) {
        return snapshot(player).betaPower();
    }

    public static float gamma(ServerPlayer player) {
        return snapshot(player).activeGammaPower();
    }
