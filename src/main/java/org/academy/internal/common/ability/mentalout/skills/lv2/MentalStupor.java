...
public final class MentalStupor extends Skill {
    public MentalStupor() {
        super(Builder
    ...
    public static final class Client {
        public static final AbilitySystemClient.SkillInfo SKILL_INFO = AbilitySystemClient.addSkillInfo(
                ...
                new AbilitySystemClient.SkillInfo(
                        Skills.MENTAL_STUPOR.get(),
                        List.of(TargetMisidentification.Client.SKILL_INFO),
                        R.textures.ability.mentalout.skill.mental_stupor.icon,
                        116,
                        76
                )
        );
        public static final String KEY_NAME_USE = SkillNames.MENTAL_STUPOR + "_use";
        ...
        private static void use() {
            if (ClientUtil.hasScreen() || !AbilitySystemClient.canUseSkill(Skills.MENTAL_STUPOR.get())) return;
    ...
    public static final class Server {
        ...
        public static void handle(UsePacket packet) {
            if (!MentaloutRequestGuard.acceptSkillUse(
                    ...
                    MentaloutRequestGuard.SkillUse.MENTAL_STUPOR,
            ...
            var wasActive = context.isStuporEnabled();
            var result = context.toggleStupor();
            if (result.insufficientCp()) {
                feedback(player, "message.academy.mentalout.insufficient_cp");
            } else if (wasActive) {
                feedback(player, "message.academy.mentalout.mental_stupor.cleared");
    ...
    public static final class UsePacket extends Packet<ServerGamePacketListenerImpl, UsePacket> {
        ...
        public PacketType<ServerGamePacketListenerImpl, UsePacket> getPacketType() {
            return PacketTypes.MENTAL_STUPOR_USE.get();
        }
    }
}
