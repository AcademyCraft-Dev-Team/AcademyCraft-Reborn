...
public class VectorDeviation extends Skill {
    ...
    public static final class Client {
        public static final AbilitySystemClient.SkillInfo SKILL_INFO = AbilitySystemClient.addSkillInfo(
                ...
                new AbilitySystemClient.SkillInfo(Skills.VECTOR_DEVIATION.get(), List.of(), R.textures.ability.accelerator.skill.vector_deviation.icon, 145, 53)
        );
        public static final String KEY_NAME_TOGGLE = SkillNames.VECTOR_DEVIATION + "_toggle";
        ...
        private static void registerSettings() {
            ...
            SkillSettingsRegistry.INSTANCE.register(
                    Skills.VECTOR_DEVIATION.get(),
                    new SkillSettingsRegistry.Module(
                            "distortion_ring",
                            "",
                            List.of(new SkillSettingsRegistry.Toggle(
                                    "first_person_distortion_ring",
                                    "app.academy.skill_settings.advanced.vector_deviation_first_person_distortion_ring",
        ...
        public static void onToggle() {
            if (!AbilitySystemClient.beginToggleRequest(Skills.VECTOR_DEVIATION.get())) return;
        ...
        public static class Config extends KeyBindingConfig {
            ...
            public static final class Action implements TypeHandler<Config> {
                ...
                @Override
                public VectorDeviation.Client.Config getDefault() {
                    return new Config();
                }
    ...
    public static final class TogglePacket extends Packet<ServerGamePacketListenerImpl, TogglePacket> {
        ...
        public PacketType<ServerGamePacketListenerImpl, TogglePacket> getPacketType() {
            return PacketTypes.VECTOR_DEVIATION_TOGGLE.get();
        }
    }
}
