...
public final class PressureLock extends Skill {
    ...
    public static final class Client {
        ...
        public static final String KEY_NAME_START = SkillNames.PRESSURE_LOCK + "_start";
        public static final String KEY_NAME_STOP = SkillNames.PRESSURE_LOCK + "_stop";
        public static Config CONFIG = new Config();
        private static int targetId = -1;

        private static void start() {
            if (AbilitySystemClient.canUseSkill(Skills.PRESSURE_LOCK.get())) {
                targetId = -1;
        ...
        @SubscribePacket
        public static void handle(TargetPacket packet) {
            targetId = packet.targetId;
        }

        @SubscribeEvent
        public static void onRender(LevelRenderEvent event) {
    ...
    public static final class Server {
        ...
        private static final class Context extends ServerContext {
            ...
            private void end() {
                if (!ended) {
                    ended = true;
                    MisakaNetworkServer.send(player, new TargetPacket(-1));
                    unregister();
                }
            }
    ...
    public static final class StartPacket extends Packet<ServerGamePacketListenerImpl, StartPacket> {
        ...
        public PacketType<ServerGamePacketListenerImpl, StartPacket> getPacketType() {
            return PacketTypes.PRESSURE_LOCK_START.get();
        }
    }
    ...
    public static final class StopPacket extends Packet<ServerGamePacketListenerImpl, StopPacket> {
        ...
        public PacketType<ServerGamePacketListenerImpl, StopPacket> getPacketType() {
            return PacketTypes.PRESSURE_LOCK_STOP.get();
        }
    }

    @PacketTarget(ThreadType.CLIENT)
    public static final class TargetPacket extends Packet<ClientPacketListener, TargetPacket> {
        ...
        public TargetPacket(int targetId) {
            this.targetId = targetId;
        }

        @Override
        public PacketType<ClientPacketListener, TargetPacket> getPacketType() {
            return PacketTypes.PRESSURE_LOCK_TARGET.get();
        }
    }
}
