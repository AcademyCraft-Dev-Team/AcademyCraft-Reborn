...
public class MultipleBrainDomainSegmentation extends Skill {
    public MultipleBrainDomainSegmentation() {
        super(Builder
    ...
    public static final class Client {
        public static final AbilitySystemClient.SkillInfo SKILL_INFO = AbilitySystemClient.addCommonSkillInfo(
                new AbilitySystemClient.SkillInfo(Skills.MULTIPLE_BRAIN_DOMAIN_SEGMENTATION.get(), List.of(BrainDomainDevelopment.Client.SKILL_INFO), R.textures.ability.level0.skill.multiple_brain_domain_segmentation.icon, 75, 62)
        );
