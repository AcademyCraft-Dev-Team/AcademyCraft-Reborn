...
/** Field-free client dispatch class paired with {@link VrServerPlayer}. */
public class VrLocalPlayer extends LocalPlayer {
    public VrLocalPlayer(Minecraft minecraft, ClientLevel level, ClientPacketListener connection,
