...
public class AbilityDeveloperModel extends Model<AbilityDeveloperRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        var pod = up.addOrReplaceChild("pod", CubeListBuilder.create().texOffs(13, 5).addBox(-1.5F, -3.0F, -2.0F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(70, 15).addBox(2.4F, -7.0F, -4.0F, 14.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(13, 5).addBox(17.3F, -3.0F, -2.0F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-9.4F, 0.1F, 0.0F));
        ...
        var cube_r2 = pod.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(69, 0).addBox(-2.0F, -5.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(84, 0).addBox(14.9F, -5.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.45F, -1.0F, 37.5F, -0.1833F, 0.0F, 0.0F));
        ...
        var cube_r4 = pod.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(100, 1).addBox(-2.0F, 0.0F, -0.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.4F, -1.75F, 34.85F, -0.4363F, 0.0F, 0.0F));

        var cube_r5 = pod.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(84, 0).addBox(-1.5F, -5.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(17.0F, -0.983F, -0.8294F, 0.2769F, 0.2261F, 0.1332F));

        var cube_r6 = pod.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(69, 0).addBox(-1.5F, -5.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.8F, -0.983F, -0.8294F, 0.2769F, -0.2261F, -0.1332F));
        ...
        var L1 = glass.addOrReplaceChild("L1", CubeListBuilder.create().texOffs(0, 124).addBox(-0.1716F, -5.1716F, -35.0F, 0.0F, 6.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.8284F, -0.8284F, -1.0F));

        var L2 = L1.addOrReplaceChild("L2", CubeListBuilder.create(), PartPose.offset(-0.1893F, -5.2322F, -1.0F));

        var cube_r8 = L2.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 119).addBox(0.5F, -2.0F, -34.0F, 0.0F, 4.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, -1.0F, 0.0F, 0.0F, 0.0F, -0.7854F));

        var L3 = L2.addOrReplaceChild("L3", CubeListBuilder.create().texOffs(-21, 101).addBox(-6.0F, -1.0F, -35.0F, 6.0F, 0.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.8107F, -1.7678F, 1.0F));

        var R1 = glass.addOrReplaceChild("R1", CubeListBuilder.create().texOffs(0, 107).addBox(0.1716F, -5.1716F, -35.0F, 0.0F, 6.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(-18.8284F, -0.8284F, -1.0F));

        var R2 = R1.addOrReplaceChild("R2", CubeListBuilder.create(), PartPose.offset(0.1893F, -5.2322F, -1.0F));

        var cube_r9 = R2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 114).addBox(-0.5F, -2.0F, -34.0F, 0.0F, 4.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.75F, -1.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

        var R3 = R2.addOrReplaceChild("R3", CubeListBuilder.create().texOffs(-36, 102).addBox(0.0F, -1.0F, -35.0F, 6.0F, 0.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(2.8107F, -1.7678F, 1.0F));

        var poles = all.addOrReplaceChild("poles", CubeListBuilder.create().texOffs(142, 213).addBox(4.0F, -1.0F, -20.0F, 2.0F, 2.0F, 20.0F, new CubeDeformation(0.0F))
                .texOffs(142, 213).addBox(-6.0F, -1.0F, -20.0F, 2.0F, 2.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.9F, 32.9F));
        ...
        var base = all.addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 204).addBox(-15.0F, -7.0F, -14.0F, 1.0F, 7.0F, 45.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 222).addBox(-32.0F, -6.0F, -14.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(11, 222).addBox(-21.0F, -6.0F, -14.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(22, 225).addBox(-29.0F, -3.0F, -14.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 42).addBox(-22.0F, -2.9F, 19.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(50, 234).addBox(-32.0F, -2.9F, 19.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(25.0F, 16.4F, 11.9F));
