...
public class OmniCraftingTableModel extends Model<OmniCraftingTableRenderState> {
    ...
    public OmniCraftingTableModel(ModelPart root) {
        ...
        this.display = this.main.getChild("display");
        this.printer = this.main.getChild("printer");
        this.base = this.printer.getChild("base");
        this.arm1 = this.base.getChild("arm1");
        this.arm2 = this.arm1.getChild("arm2");
        this.arm3 = this.arm2.getChild("arm3");
        this.beam_li = this.arm3.getChild("beam_li");
        this.holographcrafting = this.main.getChild("holographcrafting");
        this.inside = this.holographcrafting.getChild("inside");
        this.outside = this.holographcrafting.getChild("outside");
        this._fluid = this.all.getChild("_fluid");
        this.craftinggrid_end = this.all.getChild("craftinggrid_end");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition main = all.addOrReplaceChild("main", CubeListBuilder.create().texOffs(0, 55).addBox(-5.0F, -1.0F, -6.0F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(35, 139).addBox(12.0F, -0.5F, -3.5F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -16.0F, -1.0F));

        PartDefinition cube_r1 = main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(117, 57).addBox(-2.5F, -4.0F, 1.6F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r2 = main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -6.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(15.0F, -0.25F, -1.5F, 0.1745F, 0.0F, 0.0F));

        PartDefinition cube_r3 = main.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(11, 122).addBox(-4.25F, -7.0F, 2.0F, 8.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(15.25F, -2.5F, -5.5F, -0.3491F, 0.0F, 0.0F));

        PartDefinition display = main.addOrReplaceChild("display", CubeListBuilder.create(), PartPose.offset(0.0F, 13.5F, 1.5F));

        PartDefinition cube_r4 = display.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 132).addBox(-7.25F, -9.0F, 0.0F, 14.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(15.25F, -16.0F, -7.0F, -0.3491F, 0.0F, 0.0F));

        PartDefinition printer = main.addOrReplaceChild("printer", CubeListBuilder.create(), PartPose.offset(-19.0F, 16.0F, 1.5F));

        PartDefinition base = printer.addOrReplaceChild("base", CubeListBuilder.create().texOffs(69, 103).addBox(-2.0F, -2.0F, -3.0F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(32.0F, -16.0F, 3.0F));

        PartDefinition arm1 = base.addOrReplaceChild("arm1", CubeListBuilder.create(), PartPose.offset(0.5F, 0.0F, -0.5F));

        PartDefinition cube_r5 = arm1.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(71, 126).addBox(-1.5F, -8.0F, -1.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition arm2 = arm1.addOrReplaceChild("arm2", CubeListBuilder.create(), PartPose.offset(0.9F, -7.3F, 0.0F));

        PartDefinition cube_r6 = arm2.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(77, 126).addBox(1.25F, -8.0F, -0.5F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition arm3 = arm2.addOrReplaceChild("arm3", CubeListBuilder.create(), PartPose.offset(-3.25F, -5.25F, 0.0F));

        PartDefinition cube_r7 = arm3.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(76, 97).addBox(-2.25F, 1.75F, -1.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition beam_li = arm3.addOrReplaceChild("beam_li", CubeListBuilder.create(), PartPose.offset(-1.25F, 2.75F, 0.5F));

        PartDefinition cube_r8 = beam_li.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(95, 124).addBox(-1.25F, 4.25F, -1.0F, 0.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition holographcrafting = main.addOrReplaceChild("holographcrafting", CubeListBuilder.create(), PartPose.offset(0.0F, 4.0F, 0.0F));

        PartDefinition inside = holographcrafting.addOrReplaceChild("inside", CubeListBuilder.create().texOffs(37, 70).addBox(-1.0F, -3.1F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, -1.0F, -0.5F));

        PartDefinition outside = holographcrafting.addOrReplaceChild("outside", CubeListBuilder.create().texOffs(37, 59).addBox(-1.0F, -3.1F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, -1.0F, -0.5F));

        PartDefinition _fluid = all.addOrReplaceChild("_fluid", CubeListBuilder.create().texOffs(0, 89).addBox(-20.0F, -21.0F, -4.5F, 3.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(15.0F, 8.0F, -1.0F));

        PartDefinition craftinggrid_end = all.addOrReplaceChild("craftinggrid_end", CubeListBuilder.create().texOffs(3, 74).addBox(-4.0F, -0.01F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -17.0F, -1.0F));
