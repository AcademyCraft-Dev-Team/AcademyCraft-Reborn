...
public final class ItemRenderers {
    ...
    public static final ItemRenderer WIRELESS_NODE =
            register(Items.WIRELESS_NODE.get(), WirelessNodeBlockItemRenderer.INSTANCE);
    public static final ItemRenderer IMAG_PHASE_DOWSING_ROD =
            register(Items.IMAGIPHASE_DOWSING_ROD.get(), ImagiphaseDowsingRodItemRenderer.INSTANCE);
    public static final ItemRenderer OMNI_CRAFTING_TABLE =
            register(Items.OMNI_CRAFTING_TABLE.get(), OmniCraftingTableBlockItemRenderer.INSTANCE);
