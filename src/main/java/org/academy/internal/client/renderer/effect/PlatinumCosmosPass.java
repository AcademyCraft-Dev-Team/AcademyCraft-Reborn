...
public final class PlatinumCosmosPass {
    ...
    static void enqueueThirdPerson(PoseStack poseStack, int entityId, double currentTick, float effectTime) {
    ...
    public static void renderWorld(FeatureRenderDispatcher dispatcher) {
        ...
        try {
            for (var instance : instances) {
                WingEffectRenderer.PLATINUM.submitThirdPersonCosmos(
    ...
    public static void renderFirstPersonHand(FeatureRenderDispatcher dispatcher, float partialTick) {
        ...
        try {
            var submitted = WingEffectRenderer.PLATINUM.submitFirstPersonCosmos(
