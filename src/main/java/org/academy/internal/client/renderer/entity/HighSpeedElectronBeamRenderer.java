...
public class HighSpeedElectronBeamRenderer extends EntityRenderer<HighSpeedElectronBeam, HighSpeedElectronBeamRenderState> {
    ...
    @Override
    public void render(HighSpeedElectronBeamRenderState renderState, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        ...
        BoxRenderer.renderFilledBox(poseStack, bufferSource, HEAD, 0, 1, 0, 0.125f);
        poseStack.scale(0.5f, 0.5f, 0.5f);
        BoxRenderer.renderFilledBox(poseStack, bufferSource, HEAD, 1, 1, 1, 1f);
        poseStack.popPose();
        ...
        BoxRenderer.renderFilledBox(poseStack, bufferSource, RAY, 0, 1, 0, 0.125f);
        poseStack.scale(0.75f, 1, 0.75f);
        BoxRenderer.renderFilledBox(poseStack, bufferSource, RAY, 1, 1, 1, 1f);
        poseStack.popPose();
