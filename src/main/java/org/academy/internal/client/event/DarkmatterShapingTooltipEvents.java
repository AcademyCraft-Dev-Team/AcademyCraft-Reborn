...
public final class DarkmatterShapingTooltipEvents {
    ...
    public static void onTooltip(ItemTooltipEvent event) {
        ...
        if (DarkmatterItemUtil.isShapedItem(stack)
                ...
                == org.academy.api.common.ability.darkmatter.DarkmatterShape.BLOCK) {
        ...
        if (DarkmatterItemUtil.hasNativeItemEffects(stack)
                || stack.is(org.academy.internal.common.world.item.Items.DARKMATTER_COATING.get())) {
    ...
    private static void appendProfile(ItemTooltipEvent event,
                                      org.academy.api.common.ability.darkmatter.DarkmatterShapingProfile profile,
                                      boolean indented) {
