...
class GraphEditorApp(private val environment: DesktopEnvironment) : EditorApp {
    ...
    private val shaderWatcher: ShaderHotReload
    private val graphWatcher: GraphHotReload
    private val mcpBridge: VfxGraphMcpBridge
    ...
    init {
        ...
        shaderWatcher = ShaderHotReload(
            modResources(environment.workingDir)
    ...
    /** 共享 main 打包资产（mod/src/main/resources/assets/academy/vfxgraph），供观察/测试（M21）。 */
    private fun packagedGraphDir(): Path = modResources(environment.workingDir)
