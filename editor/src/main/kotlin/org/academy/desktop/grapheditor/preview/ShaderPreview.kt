...
class ShaderPreview(
    ...
    private fun recompile() {
        ...
        try {
            ...
            compiledPipeline = pipeline.precompile(device, result)
    ...
    fun render(target: RenderTarget) {
        ...
        val compiledPipeline = compiledPipeline ?: return
