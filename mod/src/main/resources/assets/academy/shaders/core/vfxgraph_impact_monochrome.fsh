...
layout(location = 12) in float impactAge;
layout(location = 14) in float impactSeed;
layout(location = 13) flat in vec2 impactCenter;
layout(location = 15) flat in float impactVisible;
