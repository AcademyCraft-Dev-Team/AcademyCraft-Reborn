...
import org.academy.internal.client.hud.ability.AbilityInfoHud
...
object SkillSettingsApp : App {
    ...
    private class Context : WidgetContext, CaptureHost {
        ...
        private var pendingSidePin: Int = InputSystem.SIDE_ANY
        ...
        private val sidePinLabelWidget = TextWidget("").apply {
            scaleX = 0.7f
            scaleY = 0.7f
        ...
        private val sidePinButton = ButtonWidget().apply {
            addChild("text", sidePinLabelWidget)
            onClickListener = {
                pendingSidePin = nextSidePin(pendingSidePin)
                updateCaptureHint()
            }
        }
        ...
        private fun createCaptureLayer(): FrameLayoutWidget {
            return object : FrameLayoutWidget() {
                init {
                    sidePinButton.layoutParams = FrameLayoutWidget.LayoutParams()
                        .size(38f, 12f)
                        .gravity(Gravity.TOP_RIGHT)
                        .margin(0f, 2f, 2f, 0f)
                    addChild("side_pin", sidePinButton)
                }
                ...
                override fun onMousePressed(event: MouseEvent) {
                    if (sidePinButton.isVisible() && sidePinButton.isMouseOver(event.x, event.y)) return
                    event.consume()
            ...
            return when (pendingType ?: return null) {
                InputSystem.InputType.KEYBOARD -> {
                    ...
                    InputSystem.combo(
                        ...
                        pendingKeys.toSet(),
                        current.action,
                        InputSystem.pinModifierSides(pendingModifiers, pendingSidePin),
        ...
        override fun resetCaptureState() {
            ...
            pendingModifiers = 0
            pendingSidePin = InputSystem.SIDE_ANY
        }
        ...
        private fun updateCaptureHint() {
            ...
            sidePinLabelWidget.text = sidePinLabel(pendingSidePin)
        }
