package org.academy.internal.client.hud.ability
...
import org.academy.api.client.hud.ability.CpBarGeometry
import org.academy.api.client.hud.ability.CpDisplayController
...
class AbilityInfoHud private constructor() {
    ...
    companion object {
        ...
        fun initMain() {
            ...
            AbilitySystemClient.registerHudToggle { instance.toggleActive() }
