...
public final class ProgramConfigurationOptions {
     ...
     */
    public static @Nullable JsonElement defaultsForConnection(
    ...
    public static boolean isPowerSlider(String field, @Nullable JsonElement currentValue) {
    ...
    public static boolean isToggle(String field, JsonElement currentValue) {
        return field.equals("enabled") && currentValue.isJsonPrimitive() && currentValue.getAsJsonPrimitive().isBoolean();
    }
    ...
    public static Option selected(List<Option> options, @Nullable JsonElement currentValue) {
    ...
    private static boolean sameValue(JsonPrimitive option, @Nullable JsonElement currentValue) {
