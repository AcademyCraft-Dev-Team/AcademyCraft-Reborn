...
public final class WingFlightClient {
    ...
    public static WingControlIntent readControl() {
        ...
        if (mc.gui.screen() == null) {
            if (down(InputConstants.KEY_W)) buttons |= WingControlIntent.FRONT;
            if (down(InputConstants.KEY_S)) buttons |= WingControlIntent.BACK;
            if (down(InputConstants.KEY_A)) buttons |= WingControlIntent.LEFT;
            if (down(InputConstants.KEY_D)) buttons |= WingControlIntent.RIGHT;
            if (down(InputConstants.KEY_SPACE)) buttons |= WingControlIntent.BOOST;
        }
