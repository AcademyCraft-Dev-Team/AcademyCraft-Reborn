...
public final class SolarGenRenderer implements BlockEntityRenderer<SolarGenBlockEntity, SolarGenRenderState> {
    ...
    public void submit(SolarGenRenderState renderState, PoseStack poseStack, SubmitNodeCollector nodeCollector, CameraRenderState cameraRenderState) {
        ...
        nodeCollector.submitModel(MODEL, renderState, poseStack, RenderTypes.entityCutout(R.textures.model.solar_gen), packedLight, packedOverlay, 0);
        if (renderState.breakProgress != null) {
            nodeCollector.submitCrumblingOverlay(MODEL, renderState, poseStack, RenderTypes.entityCutout(R.textures.model.solar_gen), packedLight, packedOverlay, 0, renderState.breakProgress);
        }
