...
public final class WindGenTopSpecialRenderer implements NoDataSpecialModelRenderer {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector nodeCollector, int packedLight, int packedOverlay, boolean hasFoil, int outlineColor) {
        ...
        nodeCollector.submitModel(WindGenTopRenderer.MODEL, new WindGenTopRenderState(), poseStack, RenderTypes.entityTranslucent(R.textures.model.wind_gen_top), packedLight, packedOverlay, outlineColor);
        poseStack.popPose();
    }
