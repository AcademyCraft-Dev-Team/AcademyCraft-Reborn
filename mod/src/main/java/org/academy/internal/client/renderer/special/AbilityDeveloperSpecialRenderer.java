...
public final class AbilityDeveloperSpecialRenderer implements NoDataSpecialModelRenderer {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, int overlayCoords, boolean hasFoil, int outlineColor) {
        ...
        submitNodeCollector.submitModel(MODEL, new AbilityDeveloperRenderState(), poseStack, Render.RenderTypes.ABILITY_DEVELOPER, lightCoords, overlayCoords, outlineColor);
