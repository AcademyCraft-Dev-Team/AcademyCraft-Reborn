...
public final class VectorReflectionClientRuntime {
    ...
    private static WeakReference<@Nullable LocalPlayer> currentPlayer = new WeakReference<>(null);
    ...
    private static boolean clearHurtState(LivingEntity living) {
        var dirty = living.hurtTime > 0 || living.hurtDuration > 0 || living.syncVelocity;
        if (!dirty) return false;
        living.hurtTime = 0;
        living.hurtDuration = 0;
        living.syncVelocity = false;
        return true;
    }
