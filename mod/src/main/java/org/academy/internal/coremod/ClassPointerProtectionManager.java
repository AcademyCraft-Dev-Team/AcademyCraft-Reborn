...
public final class ClassPointerProtectionManager {
    ...
    private static void fallback(Object player, Side side, Class<?> originalType,
                                 long originalWord, @Nullable String reason) {
    ...
    private static void logFailure(Object player, ProtectionState state, @Nullable String message) {
    ...
    private static final class ProtectionState {
        ...
        private final @Nullable Class<?> dispatchType;
        ...
        private ProtectionState(Side side, ProtectionBackend backend, Class<?> originalType,
                                @Nullable Class<?> dispatchType, long originalWord, long dispatchWord,
                                Map<UUID, Long> ledger, @Nullable String failureReason) {
            this.side = side;
