...
import org.academy.internal.client.gui.screen.ChunkLeapScreen;
...
public final class ChunkLeap extends Skill {
    ...
    public void initClient() {
        ...
        AcademyCraftConfig.registerTypeHandler(key,
                ChunkLeapClientConfig.Action.INSTANCE);
        var config = AcademyCraftClient.Config.INSTANCE
                .<ChunkLeapClientConfig>getConfig(key);
    ...
    public static final class Client {
        ...
        private static void openMap() {
            ...
            minecraft.gui.setScreen(new ChunkLeapScreen());
        }
    }
}
