...
public final class TeleportSafety {
     ...
     */
    public static @Nullable Vec3 findSafe(Entity entity, Vec3 desired) {
        return findSafeInLevel(entity, entity.level(), desired);
    }

    public static @Nullable Vec3 findSafe(Entity entity, ServerLevel level, Vec3 desired) {
        return findSafeInLevel(entity, level, desired);
    }

    private static @Nullable Vec3 findSafeInLevel(Entity entity, Level level, Vec3 desired) {
