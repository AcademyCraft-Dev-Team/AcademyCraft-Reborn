...
public final class ChunkTicketLeaseManager {
    ...
    public static Lease acquire(ServerLevel level, String owner, ChunkLeapRegion region) {
     ...
     */
    public static @Nullable Lease acquire(ServerLevel level, String owner, ChunkLeapRegion region, int radius) {
     ...
     */
    public static void requestViewLease(ServerLevel level, String owner, ChunkLeapRegion region) {
     ...
     */
    public static void cancelViewLease(String owner) {
