...
public final class TimedSkillEffectRuntime {
    ...
    public static Optional<Entry> consume(
            UUID source,
            UUID target,
            Skill skill,
            String effect,
    ...
    public static float maxValueForTarget(
            UUID target,
            Skill skill,
            String effect,
            long gameTime
    ...
    public static Optional<UUID> sourceForTarget(
            UUID target,
            Skill skill,
            String effect,
            long gameTime
    ...
    public static void clearSource(UUID source) {
    ...
    public static boolean schedule(ServerPlayer source, int delayTicks, Runnable action) {
