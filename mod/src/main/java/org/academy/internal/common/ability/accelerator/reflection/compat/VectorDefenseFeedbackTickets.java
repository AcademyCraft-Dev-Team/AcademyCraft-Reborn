...
public final class VectorDefenseFeedbackTickets {
    ...
    public static void commitFull(ServerPlayer defender, DamageSource source) {
    ...
    public static boolean shouldSuppressDamage(ServerPlayer defender, DamageSource source) {
    ...
    public static boolean shouldSuppressEntityEvent(ServerPlayer defender) {
        var ticket = validTicket(defender);
        if (ticket == null
                || ticket.committedAtTick != defender.level().getGameTime()
