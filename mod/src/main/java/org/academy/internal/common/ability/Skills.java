...
public final class Skills {
    ...
    public static final DeferredHolder<Skill, DarkmatterRadiation> DARKMATTER_RADIATION = SKILLS.register(SkillNames.DARKMATTER_INTERFERENCE, DarkmatterRadiation::new);
