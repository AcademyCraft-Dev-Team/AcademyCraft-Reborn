...
final class PlatinumExecutionCleanup {
    ...
    private static boolean matchesExecution(@Nullable Object value, PendingCleanup pending) {
    ...
    private static @Nullable Object read(Field field, @Nullable Object owner) {
        try {
    ...
    private static void write(Field field, @Nullable Object owner, @Nullable Object value) {
        try {
