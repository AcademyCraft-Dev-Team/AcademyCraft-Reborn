...
public final class TrueHealthOffsetGameTests {
    ...
    public static void registerTests(RegisterGameTestsEvent event) {
        ...
        var data = GameTestData.of(environment, Identifier.withDefaultNamespace("empty"),
    ...
    private static void verify(GameTestHelper helper) {
        ...
        locked.setPos(helper.absoluteVec(new Vec3(3, 2, 3)));
        ...
        ordinary.setInvulnerableTime(0);
        ...
        restored.setPos(helper.absoluteVec(new Vec3(7, 2, 3)));
        ...
        protectedCow.setItemInHand(InteractionHand.MAIN_HAND,
        ...
        Consumer<LivingDeathEvent> cancelDeath =
                event -> {
                    if (event.getEntity() == canceled) event.setCanceled(true);
                };
        ...
        Consumer<LivingHealEvent> cancelHeal =
                event -> {
                    if (event.getEntity() == locked) event.setCanceled(true);
                };
        ...
        try {
            ...
            NeoForge.EVENT_BUS.unregister(cancelHeal);
        }
        ...
        helper.assertTrue(Arrays.stream(LivingEntity.class.getDeclaredMethods())
    ...
    private static final class OffsetTest extends GameTestInstance {
        ...
        private OffsetTest(TestData<Holder<TestEnvironmentDefinition<?>>> info) {
            super(info);
        }
        ...
        protected MutableComponent typeDescription() {
            return Component.literal("True health projection");
        }
    }
}
