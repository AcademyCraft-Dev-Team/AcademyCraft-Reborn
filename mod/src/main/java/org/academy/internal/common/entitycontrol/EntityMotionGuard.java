...
public final class EntityMotionGuard {
    ...
    public static void imprison(
            ...
            @Nullable Consumer<LivingEntity> forcedDisplacementReaction
    ) {
    ...
    public static @Nullable Entity currentMotionSourceEntity() {
        var sources = MOTION_SOURCES.get();
    ...
    private static @Nullable Imprisonment activeState(LivingEntity entity) {
