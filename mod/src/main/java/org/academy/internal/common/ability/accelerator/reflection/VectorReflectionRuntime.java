...
public final class VectorReflectionRuntime {
    ...
    private static void logRecoveryFailure(ServerPlayer player, String operation,
                                           @Nullable Throwable error, Anchor anchor) {
    ...
    private static boolean isAcademyStateCaller(String entryMethod) {
        ...
        try {
            var callerDomain = caller.getProtectionDomain();
            CodeSource callerSource = callerDomain == null ? null : callerDomain.getCodeSource();
    ...
    private static final class Anchor {
        ...
        private @Nullable SurvivalDefenseLease survivalDefense;
        private @Nullable TemporalImmunityLease temporalImmunity;
