...
public final class DefaultPlayerNavigationAdapter implements PlayerNavigationAdapter {
    ...
    private static @Nullable PlayerMovementMode vehicleMode(@Nullable Entity vehicle, ServerPlayer subject) {
    ...
    private static final class PlayerPathBinding implements ControlBinding {
        ...
        private @Nullable Search search;
        ...
        private @Nullable ControlFailureReason failure;
        private @Nullable Skill autoEnabledFlight;
        private boolean autoEnabledVanillaFlight;
        private @Nullable Vec3 plannedGoal;
        private @Nullable Vec3 lastProgressPosition;
        private int lastProgressTick;
        private @Nullable PlayerMovementMode lastRequestedMode;
        ...
        private @Nullable Vec3 resolveGoal() {
            return switch (destination) {
                ...
                case ControlDestination.Entity entity -> {
                    var target = MentalControlRuntime.findLivingEntity(
                            Objects.requireNonNull(subject.level().getServer()), entity.uuid());
        ...
        private boolean canOccupy(BlockPos pos) {
            var level = subject.level();
            var body = subject.isPassenger() ? Objects.requireNonNull(subject.getVehicle()) : subject;
        ...
        private final class Search {
            ...
            private @Nullable SearchNode found;
            ...
            private @Nullable SearchNode pollOpen() {
                while (!open.isEmpty()) {
    ...
    private record SearchNode(NodeKey key, double cost, double heuristic, @Nullable SearchNode parent) {
