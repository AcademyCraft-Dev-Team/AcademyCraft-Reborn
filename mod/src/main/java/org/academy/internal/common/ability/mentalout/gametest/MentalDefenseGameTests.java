...
public final class MentalDefenseGameTests {
    ...
    private static void registerTests(RegisterGameTestsEvent event) {
        ...
        event.registerTest(AcademyCraft.academy("mental_defense"), new Instance(GameTestData.of(
    ...
    private static void verify(GameTestHelper helper) {
        ...
        testTags.put(MentalControlTags.IMMUNE, List.of(
                BuiltInRegistries.ENTITY_TYPE.wrapAsHolder(EntityTypes.COW), BuiltInRegistries.ENTITY_TYPE.wrapAsHolder(EntityTypes.PIG),
                BuiltInRegistries.ENTITY_TYPE.wrapAsHolder(EntityTypes.CHICKEN)));
        testTags.put(MentalControlTags.RESISTANCE, List.of(
                BuiltInRegistries.ENTITY_TYPE.wrapAsHolder(EntityTypes.SHEEP), BuiltInRegistries.ENTITY_TYPE.wrapAsHolder(EntityTypes.PLAYER)));
        ...
        try {
            ...
            if (!feedbackRegistered) {
                ...
                MentalControlFeedbackApi.registerImmuneFeedback(Identifier.withDefaultNamespace("pig"),
                        (_, _) -> {
                            throw new IllegalStateException("Expected feedback fallback test");
                        });
