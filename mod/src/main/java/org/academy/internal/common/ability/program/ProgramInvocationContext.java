...
public final class ProgramInvocationContext {
    ...
    private final ProgramTriggers.@Nullable Type trigger;
    private final CommonProgramNodeCatalog.@Nullable MovementCondition movement;
    ...
    public ProgramInvocationContext(
            UUID programId,
            int slot,
            ProgramTriggers.@Nullable Type trigger,
