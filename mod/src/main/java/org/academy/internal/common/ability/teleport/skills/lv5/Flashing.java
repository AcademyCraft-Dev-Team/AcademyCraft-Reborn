...
public final class Flashing extends Skill {
    ...
    static @Nullable Vec3 findDashDestination(
            LivingEntity player,
            Vec3 eyePosition,
            Vec3 direction
    ) {
    ...
    public static final class Client {
        ...
        private static boolean isDirectionKeyDown(Direction direction) {
            var key = switch (direction) {
                case FORWARD -> InputConstants.KEY_W;
                case BACK -> InputConstants.KEY_S;
                case LEFT -> InputConstants.KEY_A;
                case RIGHT -> InputConstants.KEY_D;
            };
    ...
    public static final class Server {
        ...
        private static @Nullable Vec3 findAutoEscapeDestination(ServerPlayer player, Vec3 sourcePosition) {
    ...
    public static final class Events {
        ...
        public static void onDrops(LivingDropsEvent event) {
            ...
            if (!(target.level() instanceof net.minecraft.server.level.ServerLevel)
                    || target.getRandom().nextFloat() >= 0.25f) return;
