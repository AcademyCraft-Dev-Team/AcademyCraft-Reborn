...
public final class SpatialStorageGameTests {
    ...
    private static void registerTests(RegisterGameTestsEvent event) {
        ...
        event.registerTest(AcademyCraft.academy("spatial_storage"), new Instance(GameTestData.of(
    ...
    private static final class Instance extends GameTestInstance {
        ...
        public void run(GameTestHelper helper) {
            ...
            try {
                ...
                try {
                    AbilityBlockDrops.run(player, () -> {
                        throw new IllegalStateException("scope test");
                    });
