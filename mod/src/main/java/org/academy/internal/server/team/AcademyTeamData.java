...
public final class AcademyTeamData extends SavedData {
    ...
    public Optional<String> teamFor(UUID playerId) {
    ...
    public Set<UUID> members(String name) {
        var team = teams.get(normalize(name));
        return team == null ? Set.of() : team.members;
    }

    public Set<String> invitationsFor(UUID playerId) {
    ...
    public MutationResult create(UUID owner, String requestedName) {
    ...
    public MutationResult invite(UUID owner, UUID target) {
    ...
    public MutationResult accept(UUID playerId, String requestedName) {
    ...
    public MutationResult leave(UUID playerId) {
    ...
    public MutationResult kick(UUID owner, UUID target) {
        if (owner.equals(target)) return MutationResult.CANNOT_TARGET_SELF;
        var name = teamFor(owner).orElse(null);
        if (name == null) return MutationResult.NOT_IN_TEAM;
        var team = teams.get(name);
    ...
    public MutationResult disband(UUID owner) {
        var name = teamFor(owner).orElse(null);
        if (name == null) return MutationResult.NOT_IN_TEAM;
