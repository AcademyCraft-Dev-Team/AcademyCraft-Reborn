...
public final class ChunkMapSelection {
     ...
     */
    private @Nullable ChunkPos targetOrigin;
    private @Nullable ResourceKey<Level> targetDimension;
    ...
    public @Nullable ResourceKey<Level> sourceDimension() {
     ...
     */
    private void rebaseIfNeeded(@Nullable ResourceKey<Level> dimension) {
     ...
     */
    public @Nullable ChunkLeapSelection sourceSelection() {
     ...
     */
    public @Nullable ChunkLeapRegion sourceBounds() {
    ...
    public @Nullable ChunkPos targetOrigin() {
        return targetOrigin;
    }
     ...
     */
    public void setTargetOrigin(@Nullable ResourceKey<Level> dimension, @Nullable ChunkPos origin) {
     ...
     */
    public @Nullable ChunkLeapSelection targetSelection() {
        if (!hasTarget()) return null;
        var sourceIn = sourceSelection();
        return sourceIn == null ? null
                : sourceIn.anchoredAt(Objects.requireNonNull(targetDimension), Objects.requireNonNull(targetOrigin));
    }
    ...
    public @Nullable BlockPos entityTarget() {
        return entityTargetSet
                ? new BlockPos(entityTargetX, entityTargetY, entityTargetZ) : null;
    }
