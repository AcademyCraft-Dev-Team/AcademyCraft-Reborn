...
public final class ChunkMapRenderer {
    ...
    private void renderChunkCell(GuiGraphicsExtractor graphics, Geometry g,
                                 ChunkPos chunk, int fill, int borderColor) {
    ...
    private static @Nullable Identifier portraitFor(ChunkLeapPackets.Marker marker) {
    ...
    private static void blitFace(GuiGraphicsExtractor graphics, Identifier skin,
    ...
    public ChunkLeapPackets.@Nullable Marker pickMarker(Geometry g, double mouseX, double mouseY,
    ...
    public ChunkLeapPackets.@Nullable Marker hoveredMarker(Geometry g, double mouseX, double mouseY,
                                                           ResourceKey<Level> dimension) {
