...
import org.academy.internal.common.world.damagesource.DamageCompletionTracker;
...
import org.academy.internal.server.wireless.WirelessManager;
...
public final class AcademyCraftServer {
    ...
    private final DamageCompletionTracker damageCompletionTracker;
    ...
    private AcademyCraftServer(MinecraftServerContext context) {
        ...
        damageCompletionTracker = new DamageCompletionTracker();
        AbilityServerAccess.register(server, abilitySystemServer);
    ...
    public static void onServerStopping(ServerStoppingEvent event) {
        ...
        AbilityServerAccess.unregister(context);
    ...
    public DamageCompletionTracker getDamageCompletionTracker() {
        return damageCompletionTracker;
    }
    ...
    public static boolean isImagPhaseGenerationEnabled(ServerLevel level) {
