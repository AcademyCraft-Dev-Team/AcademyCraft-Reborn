...
public final class AcademyRegistrations {
    ...
    public static AcademyRegistrations create(String modId) {
        return new AcademyRegistrations(modId);
    }

    public DeferredRegister<AbilityCategory> categories() {
        return categories;
    }

    public DeferredRegister<Skill> skills() {
        return skills;
    }

    public DeferredRegister<AbilityDamageProfile> damageProfiles() {
        return damageProfiles;
    }

    public DeferredRegister<ProgramNodeType<?>> programNodes() {
        return programNodes;
    }

    public void bind(IEventBus modEventBus) {
