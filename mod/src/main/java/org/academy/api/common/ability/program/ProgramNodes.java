...
public final class ProgramNodes {
    ...
    public static ProgramNodeExtension<VoidConfiguration> manualEntry(ResourceKey<AbilityCategory> category) {
        ...
        return new ProgramNodeExtension<>() {
            @Override
            public Codec<VoidConfiguration> configurationCodec() {
            ...
            @Override
            public ProgramNodeSchema schema(VoidConfiguration configuration) {
            ...
            public ProgramNodeScope scope() {
                return ProgramNodeScope.category(category.identifier());
            }

            @Override
            public ProgramNodeExecution<VoidConfiguration> execution() {
