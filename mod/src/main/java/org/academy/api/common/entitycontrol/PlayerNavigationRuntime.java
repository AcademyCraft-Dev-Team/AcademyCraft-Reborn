...
public final class PlayerNavigationRuntime {
    public static final int MAX_GLOBAL_EXPANSIONS_PER_TICK = 1024;
    ...
    public static ControlBinding activate(
    ...
    public static void beginServerTick(long gameTick) {
        if (budgetTick == gameTick) return;
        budgetTick = gameTick;
        remainingBudget = MAX_GLOBAL_EXPANSIONS_PER_TICK;
    }

    public static int claimExpansionBudget(long gameTick, int requested) {
