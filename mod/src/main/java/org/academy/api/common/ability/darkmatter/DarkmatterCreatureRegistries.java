...
public final class DarkmatterCreatureRegistries {
    ...
    public static DarkmatterCreaturePartType registerPart(DarkmatterCreaturePartType type) {
    ...
    public static DarkmatterCreatureModuleType registerModule(DarkmatterCreatureModuleType type) {
