...
class WorkCommandPacketTest {
    @Test
    void workPacketPreservesSettingsAndTargetOrder() {
        ...
        try {
            ...
            try {
                decoded = WideAreaInterference.CommandPacket.CODEC.decode(copy);
            } finally {
                copy.release();
            }
    ...
    @Test
    void refusesOversizedConfigurationBeforeDispatch() {
