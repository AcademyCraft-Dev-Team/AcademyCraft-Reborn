...
class WorkSelectionTest {
    @Test
    void previewUsesTheExactInclusiveBlockRegionAtNegativeCoordinates() {
    ...
    @Test
    void numericVerticesNormalizeReversedAxesAndRejectInvalidEdits() {
    ...
    @Test
    void selectionUsesEntityBoundsRatherThanProjectedCenter() {
    ...
    @Test
    void locksHeightAndRejectsParallelOrBackwardRays() {
