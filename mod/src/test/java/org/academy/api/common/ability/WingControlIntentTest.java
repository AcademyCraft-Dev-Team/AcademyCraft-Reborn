...
class WingControlIntentTest {
    @Test
    void stableDirectionSendsFiveHeartbeatsPerSecondIncludingDiagonal() {
    ...
    @Test
    void turnsAndReleaseAreImmediateButSameTickCannotFlood() {
        var sender = new WingControlIntent.Sender();
    ...
    @Test
    void reliableBurstsDoNotMultiplyMotionAndDuplicatesDoNotRefreshTimeout() {
    ...
    @Test
    void inputValidationAndOpposingKeysAreDeterministic() {
    ...
    @Test
    void expiredBoostBecomesHoverEvenWhenWorldTicksHaveStopped() {
        var mailbox = new WingControlIntent.Mailbox();
    ...
    @Test
    void newestReleaseWinsAStalledPacketBurst() {
        var mailbox = new WingControlIntent.Mailbox();
    ...
    @Test
    void settingsChangesSendImmediatelyAndCodecPreservesThem() {
        var sender = new WingControlIntent.Sender();
