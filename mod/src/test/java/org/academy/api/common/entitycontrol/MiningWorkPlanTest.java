...
class MiningWorkPlanTest {
    ...
    @Test
    void claimsUpperLayersAndKeepsOtherWorkersTargetsOutstanding() {
        var plan = plan();
    ...
    @Test
    void blockedTargetsDoNotStarveOthersOrCountAsCompleted() {
        var plan = plan();
        plan.refresh(0, true, pos -> MiningWorkPlan.Eligibility.ELIGIBLE);
    ...
    @Test
    void unloadedCellsPreventCompletionAndReleasedClaimsCanBeReassigned() {
        var plan = plan();
