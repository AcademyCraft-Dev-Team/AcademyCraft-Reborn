...
class WorkSettingsTest {
    @Test
    void roundTripsFiltersTasksAndStoragePoints() {
    ...
    @Test
    void oldOrdersDefaultToAdaptiveAndNewModesRoundTrip() {
    ...
    @Test
    void rejectsMalformedOrUnboundedFilters() {
    ...
    @Test
    void settingsOwnTheirFilterList() {
