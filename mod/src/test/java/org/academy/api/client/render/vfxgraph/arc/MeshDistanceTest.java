...
class MeshDistanceTest {
    ...
    void pointOutsidePlaneEdgeClampedToEdge() {
        ...
        var d = MeshDistance.nearestDistance(PLANE, 2, 0, 2);
    ...
    void sphereDistanceFromCenterIsRadius() {
        ...
        var d = MeshDistance.nearestDistance(sphere, 0, 0, 0);
    ...
    void contactRangeCullsFarPoints() {
        ...
        var near = MeshDistance.nearestDistance(sphere, 0.52f, 0, 0.38f); // 靠近球面
        var far = MeshDistance.nearestDistance(sphere, 5f, 0, 5f);        // 远离球
