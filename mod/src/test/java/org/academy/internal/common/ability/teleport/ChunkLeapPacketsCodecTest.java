...
class ChunkLeapPacketsCodecTest {
    ...
    void swapRequestDerivesAnIdenticalTargetShape() {
        var source = ChunkLeapSelection.rectangle(OVERWORLD,
                new ChunkPos(0, 0), new ChunkPos(3, 1));
    ...
    void tilesPreservePerChunkRasters() {
        ...
        assertTrue(Arrays.equals(texels, decoded.tiles().getFirst().texels()),
    ...
    private static <P> P roundTrip(P packet, StreamCodec<ByteBuf, P> codec) {
