...
class SkillVfxPacketTest {
    ...
    @Test
    void oneShotEffectsCarryAppearanceInOneSmallPacket() {
    ...
    @Test
    void rejectsInvalidPureVisualParameters() {
        for (var state : new SkillVfxState[]{
    ...
    @Test
    void reflectedBeamIsSelfContained() {
    ...
    @Test
    void chargingAndFlyingPlasmaHaveIndependentSchemas() {
    ...
    @Test
    void burstAndEndDoNotRequireAnEntity() {
    ...
    @Test
    void shortBurstFitsSmallApplicationPacket() {
        var buffer = Unpooled.buffer();
        try {
    ...
    @Test
    void rejectsNonFiniteGeometryAndUnboundedLifetimes() {
