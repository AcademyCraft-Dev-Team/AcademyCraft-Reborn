...
class HealthOffsetStateTest {
    ...
    @Test
    void waitsTenSecondsThenReleasesLinearlyAndExactly() {
    ...
    @Test
    void denseAndSparseTicksProduceTheSameResult() {
    ...
    @Test
    void rehitUsesCurrentHealthAndRestartsOnlyTheHitTimer() {
    ...
    @Test
    void healingReleasesOnlyItsAmountWithoutExtendingTheDeadline() {
        var state = new HealthOffsetState(100, 70, 0);
        state.heal(10);
    ...
    @Test
    void maxHealthGrowthDoesNotReleaseTheExistingCeiling() {
        var state = new HealthOffsetState(100, 70, 0);
    ...
    @Test
    void deadStateCannotDecayOrHeal() {
    ...
    @Test
    void encodedFieldDoesNotContainThePlainOffset() {
        var state = new HealthOffsetState(100, 70, 0);
