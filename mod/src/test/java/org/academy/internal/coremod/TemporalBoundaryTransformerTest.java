...
public class TemporalBoundaryTransformerTest {
    ...
    @Test
    void externalCancellationCannotStopProtectedBodyButOwnCancellationAndUnprotectedTicksRemain() throws Throwable {
    ...
    @Test
    void callbackIsolationDoesNotLeakCancelledStateToLaterOwnedHooks() {
    ...
    public static class Sample {
        ...
        private void ownHook(boolean cancel, CallbackInfo ci) {
            if (cancel) ci.cancel();
        }

        private void unknownAddonHook(CallbackInfo ci) {
            count++;
            ci.cancel();
        }
    }
